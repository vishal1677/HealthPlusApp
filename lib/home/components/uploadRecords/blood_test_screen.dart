...
// uploading image from here
  void uploadImage() async {
    ...
    final request = http.MultipartRequest(
        "POST", Uri.parse("https://db75-106-193-214-189.in.ngrok.io/predict-from_blood"));
      ...
      Column(
        ...
        children: [
          ...
          ElevatedButton(
              ...
              child: Text("Upload report and get prediction", style: TextStyle(color: Colors.white,fontSize:18)),
